 ...
 */
class NeighborhoodPolygonDisqus extends \Zend\View\Helper\AbstractHelper {
    
    public function __invoke( $neighborhoodPolygonId ) {
        $html=<<<EOF
    <div id="disqus_thread"></div>
    <script type="text/javascript">
        /* * * CONFIGURATION VARIABLES: EDIT BEFORE PASTING INTO YOUR WEBPAGE * * */
        var disqus_shortname = 'whathood'; // required: replace example with your forum shortname
        var disqus_url = 'http://whathood.in/n/id/$neighborhoodPolygonId';
