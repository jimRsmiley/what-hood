 ...
 */
class Neighborhood extends \Application\Entity\Neighborhood implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'dateTimeAdded', 'region', 'neighborhoodPolygons');
    }
