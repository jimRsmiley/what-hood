 ...
 */
class Region extends \Whathood\Entity\Region implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'neighborhoodPolygons');
        }
    ...
    public function setNeighborhoodPolygons($arrayCollection)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNeighborhoodPolygons', array($arrayCollection));
    ...
    public function getNeighborhoodPolygons()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNeighborhoodPolygons', array());
