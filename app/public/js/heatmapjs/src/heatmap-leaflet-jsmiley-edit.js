/*
 * jsmiley - had to edit the radius option in draw to get it to work
 * 
 ...
 */
 ...
 L.TileLayer.HeatMap = L.TileLayer.Canvas.extend({
    ...
    setData: function(max,dataset) {
        ...
        // should really clear out that maxValue calc right above if I'm going to hack this
