...
class DDC881Test extends \Doctrine\Tests\OrmFunctionalTestCase
{
    ...
    public function testIssue()
    {
        ...
        $phoneAlbert1->getWhathoodUser($albert);
        ...
        $phoneAlbert2->getWhathoodUser($albert);
        ...
        $phoneAlfons1->getWhathoodUser($alfons);
        ...
        $phoneAlfons2->getWhathoodUser($alfons);
...
class DDC881PhoneNumber
{
    ...
    public function getWhathoodUser(DDC881User $user)
    {
        $this->user = $user;
    }
