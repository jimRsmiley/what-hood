...
class DDC1545Test extends \Doctrine\Tests\OrmFunctionalTestCase
{
    ...
    public function testLinkObjects()
    {
        ...
        $this->assertNotNull($article->whathoodUser);
        $this->assertEquals($user->id, $article->whathoodUser->id);
    }
    ...
    public function testUnlinkObjects()
    {
        ...
        $this->assertNull($article->whathoodUser);
    }
    ...
    public function testChangeLink()
    {
        ...
        $this->assertNotNull($article->whathoodUser);
        $this->assertEquals($user2->id, $article->whathoodUser->id);
    }
