...
$validator = new \DoctrineModule\Validator\ObjectExists(array(
    'object_repository' => $objectManager->getRepository('Application\Entity\WhathoodUser'),
    'fields' => array('email')
));
	...
	public function __construct(ServiceManager $serviceManager)
	{
		...
		$this->add(array(
       	...
       	$noObjectExistsValidator = new NoObjectExistsValidator(array(
            'object_repository' => $entityManager->getRepository('Application\Entity\WhathoodUser'),
            'fields'            => 'email'
       	));
			...
			'email' => array(
				'validators' => array(
					array(
						...
						'options' => array(
							'object_manager' => $entityManager->getRepository('Application\Entity\WhathoodUser'),
							'fields' => 'email'
						)
					)
				)
...
'validators' => array(
	array(
		'name' => 'DoctrineModule\Validator\NoObjectExists',
		'options' => array(
			'object_manager' => $this->getEntityManager()->getRepository('Application\Entity\WhathoodUser'),
			'fields' => 'email'
		),
		**'messages' => array(
