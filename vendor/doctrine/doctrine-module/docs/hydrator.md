...
$hydrator = new DoctrineHydrator($objectManager, 'Application\Entity\WhathoodUser');
```
...
class BlogPost
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Application\Entity\WhathoodUser")
     */
    protected $user;
...
class BlogPost
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Application\Entity\WhathoodUser", cascade={"persist"})
     */
    protected $user;
...
class UserFieldset extends Fieldset implements InputFilterProviderInterface
{
	public function __construct(ServiceManager $serviceManager)
	{
		...
		$this->setHydrator(new DoctrineHydrator($entityManager, 'Application\Entity\WhathoodUser'))
			 ->setObject(new User());
