 ...
 */
class User extends \Application\Entity\WhathoodUser implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::toAssociativeArray();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'isAuthority', 'facebookUser');
    }
